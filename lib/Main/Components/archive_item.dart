...
class ArchiveItem extends StatefulWidget {
  final ArchiveModel doc;
  final BuildContext context;
    final Function(String,String) onSign;
  final Function(String, String) onDownload;
  const ArchiveItem({Key? key, required this.doc, required this.context, required this.onSign, required this.onDownload}) : super(key: key);

  @override
  _ArchiveItemState createState() => _ArchiveItemState();
}
